...
- 🔗 Экспорт HL7 FHIR R4 (коллекция Bundle наблюдений по каждому зубу, кодирование зубов ISO 3950 для постоянного прикуса **и** молочных зубов (51–85, без потерь при обратном импорте), локальная система кодов — сопоставление SNOMED CT запланировано); компонент кариеса с заданной тяжестью также несёт кодировку системы оценки — ICDAS на первичной (без пломбы) поверхности, CARS на рецидивирующей (с пломбой)
