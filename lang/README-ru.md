...
- 🧪 284 автоматизированных теста (Vitest) в 33 файлах: нумерация, переводы, шаблоны, i18n, компонент App, тема, сенсорный ввод, плагины и доступность
...
- `src/__tests__/` — набор тестов Vitest (284 теста в 33 файлах)
