...
export const AXES: ClinicalAxis[] = [
  ...
  { id: "crownReplace", field: "crownReplace", kind: "boolean",
    ...
    appliesWhen: (c, s) => s.toothSelection === "tooth-base" && ["emax","zircon","metal","temporary","telescope"].includes(s.crownMaterial) },
  { id: "crownNeeded", field: "crownNeeded", kind: "boolean",
    finding: { local: "crown-needed", display: "Crown needed" },
    svgLayer: "crown-needed",
    appliesWhen: (c, s) => s.toothSelection === "tooth-base" && ["natural","broken","crownprep"].includes(s.crownMaterial) },
