...
[![Version](https://img.shields.io/badge/version-1.27.0-green?style=for-the-badge)](https://github.com/ZoliQua/React-Odontogram-Modul)
...
- 🪛 Per-surface filling defects (`fillingDefect`: none / marginal / fracture / wear) on direct restorations, independent of recurrent caries — authored via a per-surface indicator on the Fillings card (mirroring the caries-depth indicator), rendered on the chart, and shown in the tooltip and the whole-mouth fillings summary with an explicit label (e.g. "36 (O) – Filling defect: O: marginal"), the same way recurrent caries is labeled on the Caries line
...
- 🧪 791 automated tests passing (1 additional test skipped) (Vitest) across 88 test files covering numbering, translations, presets, i18n, App component, theme, touch, plugins, accessibility, and clinical-axis/diagnosis parity
...
- 🧪 791 pruebas automatizadas superadas (1 prueba adicional omitida) (Vitest) en 88 archivos de test, para numeración, traducciones, plantillas, i18n, componente App, tema, táctil, plugins, accesibilidad y paridad de ejes clínicos/diagnósticos
